...
class LinkResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                Tabs::make()
                    ->tabs([
                        static::getUtmTab(),
                        static::getChoicesTab(),
                        static::getSecurityTab(),
                        static::getExiprationTab(),
                        static::getQrTab()
                    ])
                    ->columnSpanFull(),
            ]);
                    ...
                    Grid::make()
                        ->schema([
                            TextColumn::make('visits_count')
                                ...
                                ->formatStateUsing(
                                    fn (string $state): string => Number::abbreviate($state, 1, 2) . " views"
                                )
    ...
    public static function getUtmTab(): Tab
    {
        return Tab::make('UTM tags')
            ->icon('heroicon-o-tag')
            ->schema([
    ...
    public static function getChoicesTab(): Tab
    {
        return Tab::make('Choices')
    ...
    public static function getSecurityTab(): Tab
    {
    ...
    public static function getExiprationTab(): Tab
    {
        return Tab::make('Expiration')
            ->icon('heroicon-o-calendar')
            ->schema([
                Placeholder::make('description')
    ...
    public static function getQrTab(): Tab
    {
        return Tab::make('QR Code')
